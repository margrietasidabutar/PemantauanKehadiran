    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav slimscrollsidebar">
            ...
            <ul class="nav" id="side-menu">
                <li>
                    <a href="home.php" class="waves-effect active">
                ...
                <div class="col-md-12">
                    <div class="white-box" >
                        <section class="m-t-40">
                            <div class="sttabs tabs-style-underline" style="margin-top: -50px">
                                <div class="content-wrap">
                                    <section id="section-underline-1">
                                        <a href="form_kehadiran_dosen.php">
                                            <div class="col-md-12" style="display: flex; justify-content: space-between; background-color: #d9d7d7; margin-bottom: 10px; margin-left: -20px; margin-right: -20px">
                                                <div>
                                                    <h3>KU42201(T)</h3>
                                                    <h5>18 Januari 2020</h5>
                                                </div>
                                                <div>
                                                    <h3 style="color: #d9d7d7">hai</h3>
                                                    <h5>08:00-09:50</h5>
                                                </div>
                                            </div>
                                        </a>
                                ...
                                <nav>
                                    <ul>
                                        <li><a href="#section-underline-1" class="sticon ti-home"><span>Hari Ini</span></a></li>
                                        <li><a href="#section-underline-2" class="sticon ti-alarm-clock"><span>Reschedule</span></a></li>
                                    </ul>
                                </nav>
                            </div>
                        </section>
