        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Konfirmasi Kehadiran Dosen</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="home.php"><i class="ti-home fa-fw"></i>Beranda</a></li>
                        <li><a href="form_kehadiran_dosen.php">Kehadiran Dosen</a></li>
                        <li class="active">Konfirmasi Kehadiran Dosen</li>
                    </ol>
                </div>
            </div>
            <!-- Main -->
                            ...
                            <div class="col-sm-12 col-xs-12">
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="id" placeholder="Masukkan Id Dosen">
                                    </div>
                                    <div class="form-group">
                                        <label for="password">Password</label>
                                        <input type="password" class="form-control" id="password" placeholder="Masukkan Password Dosen">
                                    </div>
                                    <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Konfirmasi</button>
                                </form>
                            </div>
                        </div>
                    </div>
