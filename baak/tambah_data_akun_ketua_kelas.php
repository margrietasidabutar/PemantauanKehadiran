        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Tambah Data Akun Ketua Kelas</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Tambah Data Akun Ketua Kelas</li>
                    </ol>
                </div>
            </div>
            <!-- Main -->
                            ...
                            <div class="col-sm-12 col-xs-12">
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="namaKetuaKelas" placeholder="Masukkan Nama Ketua Kelas">
                                    </div>
                                    <div class="form-group">
