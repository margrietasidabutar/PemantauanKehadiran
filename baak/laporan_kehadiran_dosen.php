    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav slimscrollsidebar">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="laporan_kehadiran_dosen.php" class="waves-effect active">
        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Laporan Kehadiran Dosen</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="home.php"><i class="ti-home fa-fw"></i>Beranda</a></li>
                        <li class="active">Laporan Kehadiran Dosen</li>
                    </ol>
                </div>
            </div>
            <!-- Main -->
                ...
                <div class="col-md-12">
                    <div class="white-box">
                        <div class="button-box" style="display: flex; justify-content: flex-end">
                            <button class="btn btn-success waves-effect waves-light" type="button"><span class="btn-label"><i class="fa fa-download"></i></span>Ekspor</button>
                        </div>
