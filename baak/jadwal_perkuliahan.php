        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Jadwal Perkuliahan</h4>
                </div>
                ...
                <div class="col-md-12">
                    <div class="white-box">
                        <div class="button-box" style="display: flex; justify-content: flex-end">
                            <a href="import_jadwal_perkuliahan.php"><button class="btn btn-success waves-effect waves-light" type="button"><span class="btn-label"><i class="fa fa-inbox"></i></span>Import Jadwal</button></a>
                        </div>
                        <div class="button-box" style="display: flex; justify-content: flex-end">
                            <a href="tambah_jadwal_perkuliahan.php"><button class="btn btn-success waves-effect waves-light" type="button"><span class="btn-label"><i class="fa fa-plus"></i></span>Tambah Jadwal</button></a>
                        </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <a href="ubah_jadwal_perkuliahan.php" data-toggle="tooltip" data-original-title="Ubah"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
