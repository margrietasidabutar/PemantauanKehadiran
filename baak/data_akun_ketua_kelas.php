    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav slimscrollsidebar">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="data_akun_ketua_kelas.php" class="waves-effect active">
                        <i class="ti-user fa-fw"></i>
        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Data Akun Ketua Kelas</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="home.php"><i class="ti-home fa-fw"></i>Beranda</a></li>
                        <li class="active">Data Akun Ketua Kelas</li>
                    </ol>
                </div>
            </div>
            <!-- Main -->
                ...
                <div class="col-md-12">
                    <div class="white-box">
                        <div class="button-box" style="display: flex; justify-content: flex-end">
                            <a href="tambah_data_akun_ketua_kelas.php"><button class="btn btn-success waves-effect waves-light" type="button"><span class="btn-label"><i class="fa fa-plus"></i></span>Tambah Akun</button></a>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>Bongson Hutagaol</td>
                                    <td>42 TRPL</td>
                                    <td>******</td>
                                    <td class="text-nowrap">
                                        <a href="ubah_data_akun_ketua_kelas.php" data-toggle="tooltip" data-original-title="Ubah"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
