        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Ubah Data Akun Ketua Kelas</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="home.php"><i class="ti-home fa-fw"></i>Beranda</a></li>
                        <li><a href="data_akun_ketua_kelas.php">Data Akun Ketua Kelas</a></li>
                        <li class="active">Ubah Data Akun Ketua Kelas</li>
                    </ol>
                </div>
            </div>
            <!-- Main -->
                            ...
                            <div class="col-sm-12 col-xs-12">
                                <form>
                                    <div class="form-group">
                                        <label for="namaKetuaKelas">Nama Ketua Kelas</label>
                                        <input type="text" class="form-control" id="namaKetuaKelas" value="Bongson Hutagaol">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="password" value="bongson123">
                                    </div>
