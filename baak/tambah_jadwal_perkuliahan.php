                            ...
                            <div class="col-sm-12 col-xs-12">
                                <form >
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="hari" placeholder="Masukkan Hari">
                                    </div>
                                    <div class="form-group">
                                        <label for="kodeMK">Kode MK</label>
                                        <input type="text" class="form-control" id="kodeMK" placeholder="Masukkan Kode MK">
                                    </div>
                                    <div class="form-group">
                                        <label for="sesi">Sesi</label>
                                        <input type="text" class="form-control" id="sesi" placeholder="Masukkan Sesi">
                                    </div>
                                    <div class="form-group">
                                        <label for="jenisSesi">Jenis Sesi</label>
                                        <input type="text" class="form-control" id="jenisSesi" placeholder="Masukkan Jenis Sesi">
                                    </div>
                                    <div class="form-group">
                                        <label for="ruangan">Ruangan</label>
                                        <input type="text" class="form-control" id="ruangan" placeholder="Masukkan Ruangan">
                                    </div>
                                    <div class="form-group">
