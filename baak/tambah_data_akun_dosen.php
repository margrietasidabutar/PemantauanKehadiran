                            ...
                            <div class="col-sm-12 col-xs-12">
                                <form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="password" placeholder="Masukkan Password Dosen">
                                    </div>
